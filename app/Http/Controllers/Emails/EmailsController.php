...
class EmailsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('lead_emails.vw-emails', [
    ...
    public function datatable_emails()
    {
        ...
        return Datatables::of($db_emails)
            ...
            ->addColumn('action', function ($data) {
                ...
                // if ($bd_users->permissao == 'Administrador') {
                $btn_excluir = '<button class="bttn-material-flat bttn-xs bttn-danger btn-excluir-emails" data-target="' . $data->id . '"><i class="ri-delete-bin-5-line"></i> Excluir</button>';
    ...
    public function excluir()
    {
        ...
        $db_empreendimentos = EmailContato::where('id', request()->id)
            ->where('id_cliente_primario', $bd_users->clientes_primarios_id_cliente_primario);
    ...
    public function encaminhar_cliente()
    {
        ...
        $rd = EmailContato::where('id', request()->id)->first();
