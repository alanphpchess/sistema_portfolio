$('#tabelaRedesSociais tbody').on('click', '.btn-direcionar-cliente', function () {
    var row = $(this).closest('tr');
    var tabelaPortais = $('#tabelaRedesSociais').DataTable().row(row).data();
...
$('#btn_encaminhar_cliente').click(function (){
    ...
    $.ajax({
        ...
        method: 'get',
        url: 'redes_sociais/encaminhar_usuario_cliente',
