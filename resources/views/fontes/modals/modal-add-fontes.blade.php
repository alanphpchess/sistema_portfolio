<div class="modal fade" id="ModalADDFontes" tabindex="-1" role="dialog" aria-labelledby="ModalADDFontesTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="ModalADDFontesTitle">Adicionar Fontes</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="form_add_fontes">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                        class="btn btn-success waves-effect waves-light btn_add_fontes">Salvar</button>
                </div>
            </form>
