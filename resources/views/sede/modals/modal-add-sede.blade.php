<div class="modal fade" id="ModalADDSede" tabindex="-1" role="dialog" aria-labelledby="ModalADDSedeTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="ModalADDSedeTitle">Adicionar Sede</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="form_add_sede">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control cnpj" id="cnpj" rows="4" name="cnpj">
                                </div>
                            </div>
                            <div class="col-lg-6 col-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control telefone" id="celular" rows="4" name="celular">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control cep" id="cep" rows="4" name="cep">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-4">
                                <div class="mb-3">
                                    ...
                                    <select id="estado" class="form-control estado" name="estado" required>
                                        <option class="estado" value="">Selecione</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"
                        class="btn btn-success waves-effect waves-light btn_add_sede">Salvar</button>
                </div>
            </form>
