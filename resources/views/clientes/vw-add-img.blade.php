            ...
            <div class="row box">
                <div class="col-md-4">
                    <div class="form-container">
                        <h5 class="modal-title mt-0" id="AddImgCliModalTitle">Imagem Principal</h5>
                        <hr />
                ...
                <div class="col-md-4">
                    <div class="form-container">
                        <h5 class="modal-title mt-0" id="AddImgCliModalTitle">Imagens do Cliente</h5>
                        <hr />
                        <div id="id_cliente" data-target="{{ $id_cliente }}"></div>
...
@hasSection('page_cli_add_img')
    @yield('page_cli_add_img')
@endif
