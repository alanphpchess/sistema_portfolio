            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0">Pastas</h4>  <a href="/admin/clientes"><button class="bttn-material-flat bttn-md bttn-danger"><i
            ...
            <div class="row box">
                <div class="form-container">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                                <a href="/admin/clientes/pastas/gerenciamento/{{ $id_cliente }}">
                            ...
                            @foreach ($grupos_pastas as $grupo_pasta)
                                <div id="lista_pasta">
                                    <div class="pastas">
                                        ...
                                        <p>
                                            <a href="/admin/clientes/pastas/arquivos/{{ $grupo_pasta->id }}">
                                                {{ $grupo_pasta->nome }}
                                            </a>
                                        </p>
                                    </div>
